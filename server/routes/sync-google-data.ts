...
export const restoreBackupData: RequestHandler = async (req, res) => {
  ...
  try {
    ...
    // Sample businesses data with proper email and website formats
    const backupBusinesses = [
      ...
      },
      {
        ...
        location: { lat: 25.209, lng: 55.279 },
        rating: 4.5,
        reviewCount: 289,
      ...
      {
        id: "ChIJN4t_tDeuEmsRUsoyG83frY7",
        name: "Al Majid Visa Services",
        address: "Deira, Dubai, UAE",
        phone: "+971-4-456-7890",
        website: "https://almajidvisa.ae",
        email: "info@almajidvisa.ae",
        location: { lat: 25.276, lng: 55.327 },
        rating: 4.1,
        reviewCount: 234,
      ...
      {
        id: "ChIJN5t_tDeuEmsRUsoyG83frY8",
        name: "Prime Visa Consultants",
        address: "Sheikh Zayed Road, Dubai, UAE",
        phone: "+971-4-567-8901",
        website: "https://primevisaconsultants.ae",
        email: "info@primevisaconsultants.ae",
        location: { lat: 25.218, lng: 55.278 },
        rating: 3.9,
        reviewCount: 198,
        category: "visa consulting services",
        businessStatus: "OPERATIONAL",
      ...
      {
        id: "ChIJN6t_tDeuEmsRUsoyG83frY9",
        name: "Dubai Express Visa",
        address: "Jumeirah, Dubai, UAE",
        phone: "+971-4-678-9012",
        website: "https://dubaiexpressvisa.ae",
        email: "info@dubaiexpressvisa.ae",
        location: { lat: 25.239, lng: 55.27 },
        rating: 4.3,
        reviewCount: 321,
        category: "immigration consultancy",
        businessStatus: "OPERATIONAL",
