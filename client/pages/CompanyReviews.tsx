    ...
    const fetchBusinessData = async () => {
      try {
        ...
        if (location.state?.businessData) {
          ...
          if (!fallbackData.reviews || fallbackData.reviews.length === 0) {
            console.log(
              "No real reviews in error fallback, generating samples",
            );
            fallbackData.reviews = generateSampleReviews(
              fallbackData.name,
              fallbackData.id,
            ...
            console.log(
              `Using ${fallbackData.reviews.length} real reviews from error fallback`,
            );
          }
          ...
          <CardContent className="p-6 md:p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-blue-100 max-w-3xl mx-auto">
                This platform works in collaboration with official Dubai
